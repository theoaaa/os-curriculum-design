...
public class MemoryManagementController {
    ...
    private static final List<ProcessMemoryBlock> processMemoryAllocatedList = new ArrayList<>();
    private int processCount = 0;                  // 进程个数

    public void initialize() {

       /* ProcessMemoryBlock p1 = new ProcessMemoryBlock(512,12,38,true);
        ProcessMemoryBlock p2 = new ProcessMemoryBlock(512,65,127,true);
        ProcessMemoryBlock p3 = new ProcessMemoryBlock(512,256,312,false);
