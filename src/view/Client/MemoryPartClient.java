...
public class MemoryPartClient extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/MemoryPart/MemoryManagementWindow.fxml"));
    ...
    public static Stage getInstance(){
        if(isExisted == false && primaryStage == null){
            //
        }
        return primaryStage;
    }
